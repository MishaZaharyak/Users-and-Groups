...
SECRET_KEY = '1&%wckcd@$%h=6lju+x)2w5sq(5hesxgqqu99tl89byp#bsg^c'
...
STATIC_URL = '/'+os.getenv('static_dir', 'frontend/static')+'/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, os.getenv('static_dir', 'frontend/static')),
)
